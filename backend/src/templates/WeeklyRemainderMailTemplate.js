...
<html>
  <head>
    <meta charset="UTF-8" />
    <title>Weekly Reminder - Connectra</title>
    <style>
      body {
  ...
  <body>
    <div class="container">
      <div class="header">
        <img src="https://res.cloudinary.com/dklos8vki/image/upload/v1747900456/logo_uzp4te.png" alt="connectra logo" />
        <p>Connect. Collaborate. Grow.</p>
      </div>
      <div class="content">
        <h2>📬 Weekly Reminder, ${name}!</h2>
        <p>Hey <strong>${name}</strong>, here’s what’s waiting for you this week on Connectra:</p>
        ...
        <p style="margin-top: 30px;">Stay awesome,<br/>The Connectra Team</p>
      </div>
      <div class="footer">
        © 2025 Connectra. All rights reserved.<br />
        You’re receiving this email because you’re part of the Connectra community.
      </div>
    </div>
  </body>
</html>
